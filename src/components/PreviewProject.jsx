...
export const PreviewProject = ({ project }) => {
	...
	return (
		<div className="border-b p-4 flex flex-col md:flex-row justify-between">
			<div className="flex items-center gap-2" >
				<p className="flex-1">
					{name}
					<span className="text-gray-500 uppercase"> {client}</span>{" "}
				</p>
				{auth._id !== creator && <p className="p-1 text-xs rounded-lg text-white bg-green-500 font-bold uppercase">Colaborador</p>}
			</div>
